$( function() {
	...
	game.save = function() {
		...
		//console.log("HEY!");
		game.$save_form.submit( function( e ) { e.preventDefault() } );
		$.blockUI("<h2>Game is Saving!</h2>");
		$.post( "save.php", game.$save_form.serializeObject(), game.callback );
		console.log( game.$save_form.serializeObject() );
	...
	game.fruit_expire = function() {
		game.fruit_set( Math.ceil( game.fruit / 2 ) );
	};
	...
	game.fruit_set = function ( amount ) {
		game.fruit = amount;
		game.$fruit.html( amount );
	};
